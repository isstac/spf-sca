...
class Socket {
    ...
    private boolean shutOut = false;
 	...
 	private static OutputStream os = new OutputStream(OutputStream.SOCKET);
 	private InputStreamOld is = new InputStreamOld();
    ...
    {
    	/* Sang: analyze the client without connecting it to a server socket
    ...
    public InputStream getInputStream() throws IOException {
    	// Sang: return symbolic input stream
        // return is;
    	// TODO: check this
    	return null;
    }
    ...
    public OutputStream getOutputStream() throws IOException {
        // Sang: return dummy outputstream
       return os;
    }
