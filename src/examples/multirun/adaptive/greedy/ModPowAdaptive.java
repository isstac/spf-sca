package multirun.adaptive.greedy;
...
public class ModPowAdaptive{
	...
	static {
		...
		try {
			...
			FileInputStream fstream = new FileInputStream(
					"src/examples/multirun/adaptive/greedy/ModPowAdaptive.jpf");
	...
	public static int modPowFastKocherReduction(int num, int e, int m) { 
