...
public final class MontgomeryReducer {
	...
	public BigInteger multiply(BigInteger x, BigInteger y) {
		...
		System.out.println(">>>>> After x.multiply(y)");
		BigInteger temp1 = product.and(mask);
		System.out.println(">>>>> After temp1");
		BigInteger temp2 = temp1.multiply(factor);
		System.out.println(">>>>> After temp2");
		BigInteger temp3 = temp2.and(mask);
		System.out.println(">>>>> After temp3");
		BigInteger reduced = product.add(temp3.multiply(modulus)).shiftRight(reducerBits);
